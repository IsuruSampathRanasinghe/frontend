...
export default function ForgetPassword(){
    ...
    async function changePassword() {
        ...
        try{
            ...
            toast.success("Password changed successfully. Please login with your new passsword")
            navigate("/login")
        }catch(e){
            console.error(e)
    ...
    return(
        <div className="w-full h-screen flex justify-center items-center bg-[url('/bg.jpg')] bg-cover bg-center">
            ...
            {step=="otp"&&<div className="w-[400px] backdrop-blur-lg rounded-2xl flex flex-col justify-center items-center p-6">
                <h1 className="text-2xl font-semibold text-secondary mb-6">Reset Password</h1>
                <input type="text" value={otp} onChange={(e) => setOtp(e.target.value)} placeholder="Enter Your email" className="w-full p-3 rounded-lg border border-secondary/20 mb-4 focus:outline-none focus:ring-2 focus:ring-accent" />
