        ...
        <div className="w-full lg:h-[calc(100vh-100px)] bg-primary flex flex-col pt-[25px]  items-center">
            <div className="w-[400px] lg:w-[600px] flex flex-col gap-4 ">
                ...
                <div className="w-[400px] lg:w-full h-[120px] bg-white flex flex-col-reverse lg:flex-row justify-end items-center relative">
                    <Link state={cart} to="/checkout" className="lg:absolute left-0 bg-accent text-center text-white px-6 py-3 lg:ml-[20px] hover:bg-accent/80 ">Proceed to Checkout</Link>
                    <div className="h-[50px]">
                        <span className="font-semibold text-accent w-full text-center lg:text-right text-2xl p-0 lg:pr-[10px] mt-[5px]">Total: LKR{getTotal().toFixed(2)}</span>
                    </div>
                </div>
            </div>
        </div>
